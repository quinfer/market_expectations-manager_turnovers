...
logit_baseline<-readRDS("./model/logit_poach_base.rds")
hazard_cty<-readRDS("./model/grp_lvl_poach_cty.rds")
hazard_season<-readRDS("./model/grp_lvl_poach_season.rds")
hazard_div <- readRDS("./model/grp_lvl_poach_div.rds")
logit_cty <-readRDS("./model/logit_grp_lvl_poach_cty.rds")
logit_div <- readRDS("./model/logit_grp_lvl_poach_div.rds")
logit_season <- readRDS("./model/logit_grp_lvl_poach_season.rds")
...
The subscript $l[i]$ allows coefficient variation across groups. We investigate hierarchies across season, country and country-tier. Hierarchical priors on $\alpha,\beta$ parameters share data to obtain better estimates, even for new leagues or clubs.
