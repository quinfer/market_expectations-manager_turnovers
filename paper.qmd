...
```
```{python}
#spells1['spell_in_days']=spells1['Finish']-spells1['Start']
#spells1['spell_in_days']
import csv
team_names=spells1['club'].unique()
# Convert the Series to a DataFrame
teams_df = pd.DataFrame(team_names,columns=['TeamName'])
