...
# remove duplicates
spells |> drop_na(Start,Finish) |> distinct(name,club,Finish,.keep_all = TRUE) -> spells
spell <- spells |> select(club,Start,Finish) |> arrange(Finish)
spell |> filter(Finish-Start>0) -> spell
```
...
- `name`: The name of the person in charge
- `club`: The club the manager was in charge of
- `position`: The position of the person in charge
- `Start`: The start date of the spell
- `Finish`: The end date of the spell
- `days_in_charge`: The number of days the manager was in charge of the club
- `season_start`: The start of the season the spell ended
